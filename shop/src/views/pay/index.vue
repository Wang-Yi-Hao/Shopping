    ...
    <div class="address">
      ...
      <div class="info" v-if="selectedAddress.address_id">
        ...
        <div class="info-address">
          {{selectedAddress.region.city + ' ' +selectedAddress.region.province + ' ' + selectedAddress.region.region + ' '+ selectedAddress.detail}}
        </div>
      </div>
  ...
  methods: {
    ...
    async getOrderList () {
      if (this.mode === 'cart') {
        ...
        console.log(this.mode, this.goodsId, this.goodsNum, this.goodsSkuId)
